...
const GRAMMAR: &[Check] = &[
    ...
    Check {
        ...
        rule: "a `callback_auth:` block declares a scheme, brings a non-empty `callback_allow:` of absolute http/https patterns, and neither key stands without a `callback:` (13.3, D126, D127)",
        pass: "parse/section.rs",
        codes: &[
            "missing-key",
