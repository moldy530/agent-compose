...
- Release distribution: tagged releases publish prebuilt binaries for Linux and macOS (x86_64 + arm64) on GitHub Releases, with a checksum-verified install script and a dry run of the whole pipeline on every pull request (resolved q24).
